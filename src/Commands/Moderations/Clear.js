...
module.exports = class extends Command {
    ...
    constructor(...args) {
        super(...args, {
            description: ['Clear a amount of message or message from a user.', "Efface un nombre de message ou des message d'un utilisateur."],
            category: ['Moderation', 'Modération'],
            usage: ["<number> [user]", "<nombre> [utilisateur]"],
            aliases: ["c", "broom"],
