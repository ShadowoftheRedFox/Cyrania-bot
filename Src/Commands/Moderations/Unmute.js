...
module.exports = class extends Command {
    ...
    constructor(...args) {
        super(...args, {
            description: ['Unmute someone.', "Re donne la parole à quelqu'un."],
    ...
    async run(message, [target]) {
        ...
        if (!GuildList[GID].other.mute.role) return message.channel.send("I don't know what is the muted role! Please ask a manager or an admin to do `,,setup mute`.");
